...
const H264_VIDEO_CODEC = '-c:v libx264 -pix_fmt yuv420p -profile:v high -level 4.1 -preset slower -crf 22 -tune film';

// ref. https://trac.ffmpeg.org/wiki/Encode/H.264
const HEVC_VIDEO_CODEC = '-c:v libx265 -pix_fmt yuv420p -profile:v main -preset slower -crf 27';
